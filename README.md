...
#### hls_ip_blocks (C++ / Vitis HLS):
  ...
  3. **GaussFilter_hls:** Модуль фильтра Гаусса 3х3. С постоянными коэффициентами {{1, 2, 1} {2, 4, 2} {1, 2, 1}}. Через интерфейс можно управлять яркостью изображения меня значение brightness от 0 до 255.  
